...
CONFIG_GRUB_TITLE="OpenWrt,Lean,2021.12.20"
CONFIG_ISO_IMAGES=y
...
# CONFIG_PACKAGE_kmod-leds-apu is not set
...
# CONFIG_PACKAGE_php8-fastcgi is not set
...
# CONFIG_PACKAGE_php8-mod-imap is not set
...
# CONFIG_QT5_INCLUDE_ATOMIC is not set
...
# CONFIG_PACKAGE_luci-i18n-bonding-de is not set
# CONFIG_PACKAGE_luci-i18n-bonding-en is not set
CONFIG_PACKAGE_luci-i18n-bonding-zh-cn=y
CONFIG_PACKAGE_luci-i18n-cifs-mount-zh-cn=y
# CONFIG_PACKAGE_luci-i18n-cifsd-ca is not set
# CONFIG_PACKAGE_luci-i18n-cifsd-cs is not set
# CONFIG_PACKAGE_luci-i18n-cifsd-de is not set
# CONFIG_PACKAGE_luci-i18n-cifsd-el is not set
# CONFIG_PACKAGE_luci-i18n-cifsd-en is not set
# CONFIG_PACKAGE_luci-i18n-cifsd-es is not set
# CONFIG_PACKAGE_luci-i18n-cifsd-fr is not set
# CONFIG_PACKAGE_luci-i18n-cifsd-he is not set
# CONFIG_PACKAGE_luci-i18n-cifsd-hi is not set
# CONFIG_PACKAGE_luci-i18n-cifsd-hu is not set
# CONFIG_PACKAGE_luci-i18n-cifsd-it is not set
# CONFIG_PACKAGE_luci-i18n-cifsd-ja is not set
# CONFIG_PACKAGE_luci-i18n-cifsd-ko is not set
# CONFIG_PACKAGE_luci-i18n-cifsd-ms is not set
# CONFIG_PACKAGE_luci-i18n-cifsd-nb_NO is not set
# CONFIG_PACKAGE_luci-i18n-cifsd-pl is not set
# CONFIG_PACKAGE_luci-i18n-cifsd-pt is not set
# CONFIG_PACKAGE_luci-i18n-cifsd-pt_BR is not set
# CONFIG_PACKAGE_luci-i18n-cifsd-ro is not set
# CONFIG_PACKAGE_luci-i18n-cifsd-ru is not set
# CONFIG_PACKAGE_luci-i18n-cifsd-sk is not set
# CONFIG_PACKAGE_luci-i18n-cifsd-sv is not set
# CONFIG_PACKAGE_luci-i18n-cifsd-tr is not set
# CONFIG_PACKAGE_luci-i18n-cifsd-uk is not set
# CONFIG_PACKAGE_luci-i18n-cifsd-vi is not set
CONFIG_PACKAGE_luci-i18n-cifsd-zh-cn=y
# CONFIG_PACKAGE_luci-i18n-cifsd-zh_Hant is not set
...
CONFIG_PACKAGE_luci-i18n-go-aliyundrive-webdav-zh-cn=y
# CONFIG_PACKAGE_luci-i18n-go-aliyundrive-webdav-zh_Hans is not set
...
# CONFIG_PACKAGE_luci-i18n-vnstat-ca is not set
# CONFIG_PACKAGE_luci-i18n-vnstat-cs is not set
# CONFIG_PACKAGE_luci-i18n-vnstat-de is not set
# CONFIG_PACKAGE_luci-i18n-vnstat-el is not set
# CONFIG_PACKAGE_luci-i18n-vnstat-en is not set
# CONFIG_PACKAGE_luci-i18n-vnstat-es is not set
# CONFIG_PACKAGE_luci-i18n-vnstat-fr is not set
# CONFIG_PACKAGE_luci-i18n-vnstat-he is not set
# CONFIG_PACKAGE_luci-i18n-vnstat-hu is not set
# CONFIG_PACKAGE_luci-i18n-vnstat-it is not set
# CONFIG_PACKAGE_luci-i18n-vnstat-ja is not set
# CONFIG_PACKAGE_luci-i18n-vnstat-ms is not set
# CONFIG_PACKAGE_luci-i18n-vnstat-no is not set
# CONFIG_PACKAGE_luci-i18n-vnstat-pl is not set
# CONFIG_PACKAGE_luci-i18n-vnstat-pt is not set
# CONFIG_PACKAGE_luci-i18n-vnstat-pt-br is not set
# CONFIG_PACKAGE_luci-i18n-vnstat-ro is not set
# CONFIG_PACKAGE_luci-i18n-vnstat-ru is not set
# CONFIG_PACKAGE_luci-i18n-vnstat-sk is not set
# CONFIG_PACKAGE_luci-i18n-vnstat-sv is not set
# CONFIG_PACKAGE_luci-i18n-vnstat-tr is not set
# CONFIG_PACKAGE_luci-i18n-vnstat-uk is not set
# CONFIG_PACKAGE_luci-i18n-vnstat-vi is not set
CONFIG_PACKAGE_luci-i18n-vnstat-zh-cn=y
# CONFIG_PACKAGE_luci-i18n-vnstat-zh-tw is not set
...
# CONFIG_DNSPROXY_COMPRESS_UPX is not set
...
# CONFIG_MOSDNS_COMPRESS_UPX is not set
...
CONFIG_UnblockNeteaseMusic-Go_INCLUDE_GOPROXY=y
# end of NeteaseMusic
...
# CONFIG_V2RAYA_COMPRESS_GOPROXY is not set
# CONFIG_V2RAYA_COMPRESS_UPX is not set
...
# CONFIG_SPEEDTEST_GO_COMPRESS_GOPROXY is not set
# CONFIG_SPEEDTEST_GO_COMPRESS_UPX is not set
...
# Configuration
#
# CONFIG_LXC_KERNEL_OPTIONS is not set
# CONFIG_LXC_BUSYBOX_OPTIONS is not set
CONFIG_LXC_SECCOMP=y
# CONFIG_LXC_NETWORKING is not set
# end of Configuration

CONFIG_PACKAGE_lxc-attach=y
# CONFIG_PACKAGE_lxc-auto is not set
# CONFIG_PACKAGE_lxc-autostart is not set
...
# CONFIG_PACKAGE_lxc-copy is not set
CONFIG_PACKAGE_lxc-create=y
# CONFIG_PACKAGE_lxc-destroy is not set
# CONFIG_PACKAGE_lxc-device is not set
...
# CONFIG_PACKAGE_lxc-top is not set
...
# CONFIG_PACKAGE_lxc-usernsexec is not set
